...
def main():
    """Main function to convert DOCX files to JSON."""
    print("Converting DOCX files to JSON...")
    
    # Process DOCX files
    transcripts = process_docx_files('data')
    ...
    if transcripts:
        ...
        print(f"\n✅ JSON file created successfully: {output_file}")
